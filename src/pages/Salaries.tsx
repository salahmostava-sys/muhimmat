...
import { Search, Wallet, Download, FolderOpen, CheckCircle, Printer, Upload, FileUp, ChevronUp, ChevronDown, ChevronsUpDown, LayoutGrid, Table2, AlertTriangle, FileText, Settings2, Globe, Archive, TrendingUp, Users, Building2, Loader2 } from 'lucide-react';
...
import { PayslipModal } from '@/components/salaries/PayslipModal';
import type { SalaryRow, SchemeData, SortDir, SalaryDraftPatch } from '@/components/salaries/types';
...
// types moved to `src/components/salaries/types.ts`
...
// SalaryDraftPatch moved to `src/components/salaries/types.ts`
...
// PayslipModal moved to `src/components/salaries/PayslipModal.tsx`
